...
# | menggunakan devicecode (imei) yang berbeda setiap akun

# | gunakan device_ip yang berbeda setiap akun

# | * untuk settingan lainya wajib sama

# | dengan data dari paket capture
...
# | duplikat data di atas dari anroid_id => tandatangani

# | buat file baru dengan nama bebas terserah kamu

# | diaktifkankan skrip di bawah dngn gun tanda pagar

# | Jika skrip di aktifkan maka hapus data di atas

# | ################################################ #####

# | pilih pagar di bawah untuk mengaktifkan skrip
